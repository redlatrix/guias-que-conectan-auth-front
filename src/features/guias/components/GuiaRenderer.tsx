...
export const GuiaRenderer = ({ guia }: GuiaRendererProps) => (
  <article className="max-w-6xl mx-auto bg-white rounded-2xl shadow-md p-8 border-t-4 border-olive font-public">
    ...
    <header className="mb-6 pb-5 border-b border-gray-100">
      ...
      <h1 className="font-crimson text-4xl font-bold text-olive leading-tight">
        {guia.titulo}
      </h1>
